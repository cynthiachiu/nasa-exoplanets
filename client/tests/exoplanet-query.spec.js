...
test.describe('NASA Exoplanet Query App', () => {
    ...
    test('Throw an error on purpose to showcase error reporting', async ({ page }) => {
        // NOTE: purposefully failing the check of descending should be reverse of ascending to showcase error generation report
    ...
    test('should navigate through pagination', async ({ page }) => {
        ...
        // Go to second page - MUI Pagination uses buttons with aria-label
        await page.click('.pagination button[aria-label="Go to page 2"]');
        await page.waitForLoadState('networkidle');
        ...
        // Test next button - MUI uses aria-label for navigation buttons
        await page.click('.pagination button[aria-label="Go to next page"]');
        await page.waitForLoadState('networkidle');
        ...
        await page.click('.pagination button[aria-label="Go to previous page"]');
        await page.waitForLoadState('networkidle');
